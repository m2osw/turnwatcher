...
namespace
{
	...
	const QString	HitPoints("HitPoints");
	const QString	TempHP("TempHP");
	const QString	DamageHealth("DamageHealth");
}

DamageWindow::DamageWindow( QString title, Gtk::Window& parent ) :

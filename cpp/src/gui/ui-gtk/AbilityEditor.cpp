...
#if 0
void AbilityEditor::AddDieFace( const QString& value )
{
...
void AbilityEditor::AddAbility( const QString& name, Stat::pointer_t stat )
{
...
void AbilityEditor::Apply()
{
	for( auto row : f_store->children() )
	{
		...
		QString	display_name = row[f_columns.f_displayName];
...
void AbilityEditor::on_editing_started( Gtk::CellEditable*, const QString& )
{

...
bool JumpInWindow::FindDuplicates( Combatant::Character::Pointer ch ) const
{
	assert(ch);
	assert(f_listStore);
...
Gtk::TreeIter JumpInWindow::FindCharacter( Combatant::Character::Pointer ch ) const
{
	assert(ch);
	assert(f_listStore);
...
void JumpInWindow::AddCharacter( Combatant::Character::Pointer ch )
{
	assert(ch);
...
void JumpInWindow::RemoveCharacter( Combatant::Character::Pointer ch )
{
...
Combatant::Character::Pointer JumpInWindow::GetSelected()
{

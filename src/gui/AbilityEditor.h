...
private:
	...
	public:
		...
		Gtk::TreeModelColumn<Attribute::Stat::Pointer>	f_ability;
	...
	typedef std::vector<Attribute::Stat::Pointer>	Stats;
	...
	void		AddAbility( const Glib::ustring& name, Attribute::Stat::Pointer stat );
	void 		InitDialog();
	void		ClearDialog();
};

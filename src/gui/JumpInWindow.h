...
public:
	JumpInWindow( Glib::ustring title, Gtk::Window& parent );
	~JumpInWindow();

	void AddCharacter( Combatant::Character::Pointer ch );
	...
	Combatant::Character::Pointer GetSelected();
...
private:
	...
	public:
		...
		Gtk::TreeModelColumn<Combatant::Character::Pointer>	character;
		//
		Columns()
		{
			add( name );
	...
	void 		FillMainBox();
	bool 		FindDuplicates( Combatant::Character::Pointer ch ) const;
	Gtk::TreeIter	FindCharacter( Combatant::Character::Pointer ch ) const;

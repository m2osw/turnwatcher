...
private:
	...
	public:
		...
		Gtk::TreeModelColumn<Attribute::Stat::Pointer>	f_stat;
	...
	Attribute::Stat::Pointer GetOrCreateStat( const Gtk::TreeModel::Row& row );
	void	AddStat( Attribute::Stat::Pointer stat );
	void	AddAccelKeys();
	//

...
Gtk::TreeView::Column* CharacterView::addNameColumn( const Glib::ustring& name )
{
...
Gtk::TreeView::Column* CharacterView::addInitColumn( const Glib::ustring& name )
{
	auto model(GetCharacterModel().lock());
	assert(model);
	Combatant::CharacterModel::columns_t	columns( model->getColumns( ) );
...
Gtk::TreeView::Column* CharacterView::addIconColumn( const Glib::ustring& name, Gtk::TreeModelColumnBase& column )
{
	auto model(GetCharacterModel().lock());
	assert(model);
	Combatant::CharacterModel::columns_t	columns( model->getColumns( ) );
...
Gtk::TreeView::Column* CharacterView::addTextColumn( const Glib::ustring& name, Gtk::TreeModelColumnBase& column,
...
Gtk::TreeView::Column* CharacterView::addTextColumn( const Glib::ustring& name, Gtk::TreeModelColumnBase& column, const bool render_colors )
{
	return addTextColumn( name, column, column, render_colors );
}


Gtk::TreeView::Column* CharacterView::addToggleColumn( const Glib::ustring& name, Gtk::TreeModelColumnBase& column )
{
	auto model(GetCharacterModel().lock());
	assert(model);
	Combatant::CharacterModel::columns_t	columns( model->getColumns( ) );

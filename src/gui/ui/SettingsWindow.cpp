...
namespace
{
	...
	void SetText( motk::LabelTable& tbl, const moName& id, const Glib::ustring& text )
	{
		Gtk::Entry* e;
		tbl.GetItem( id, e );
	...
	void SetFontName( motk::LabelTable& tbl, const moName& id, const Glib::ustring& text )
	{
		Gtk::FontButton* fb;
		tbl.GetItem( id, fb );

...
{
public:
	typedef std::shared_ptr<Stat>	Pointer;
	...
	void				name( const molib::moWCString& val );
	...
	molib::moWCString	accel() const					{ return f_accel; }
	void				accel( const molib::moWCString& val );
	...
	virtual void		Copy( const Pointer copy );
...
private:
	...
	bool				f_deleted;
	molib::moWCString	f_accel;			// accelerator key
...
public:
	...
	Stat::Pointer	stat() const				{ return f_stat; }
	void			stat( Stat::Pointer val )	{ f_stat = val; }
...
private:
	...
	molib::moWCString	f_notes;	// Used instead of roll value

...
public:
	...
	void AddEffects  ( Combatant::Character::Pointer ch );
	void GetEffects  ( Combatant::Character::Pointer ch );
	void AddEntry    ( const Effects::Effect::Pointer effect );
	void UpdateEffect( Effects::Effect::Pointer effect );
	void ClearEffects();

	int                      SelectedCount()     const;
	Effects::Effect::Pointer GetFirstSelected();
	void                     DeleteSelected();
	bool                     FindDuplicates(     const  Effects::Effect::Pointer effect );
...
private:
	...
	struct Columns : public Gtk::TreeModel::ColumnRecord
	{
		...
		Gtk::TreeModelColumn<Effects::Effect::Pointer>	f_effect;
	...
	void			UpdateRow( Gtk::TreeModel::Row& row, const Effects::Effect::Pointer effect );
	void			AddTooltips();
	void 			FillMainBox();
	void			OnSelected();
};
